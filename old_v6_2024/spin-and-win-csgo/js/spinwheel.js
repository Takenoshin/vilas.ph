...
function Spin2WinWheel() {
  ...
  var xmlns = "http://www.w3.org/2000/svg",
    ...
    segmentStrokeWidth,
    segmentValuesArray,
    // segmentValuesArraySecondSpin,   // added - chrisab 3-11-2021
    // segmentValuesArrayThirdSpin,    // added - chrisab 3-11-2021
    // segmentValuesArrayTryAgain,     // added - chrisab 3-14-2021
    winSpin,
    numSegments,
    numSpins,
    rotationStep,
    ...
    spinVelocityTracker,
    gameResultsArray = [],
    pegSnd = new Audio('img/wheel_tick.mp3'),
    ...
    setInitData = function() {
      ...
      winSpin = Math.floor(Math.random() * dataObj.numSpins);
    ...
    checkHasProbability = function(spinCount){
        ...
        if (spinCount == 1) {
            ...
            // }
            $('.spin-left').text(spinLeftTxt2);            
        }
        else if (spinCount == 2) {
            // segmentValuesArray = segmentValuesArrayThirdSpin;
            $('.spin-left').text(spinLeftTxt1);
        }

        // $('.spin-left').text(' Spin Left: ' + numSpins + ' - ' + spinCount);
   ...
   spinComplete = function () {
    ...
    endGame = function() {
      ...
      openCongratsPopup()
      $('.spin-left').text(noMoreSpinLeftTxt); // added - chrisab 3-11-2021
      disableWheel();
      ...
      onGameEnd({gameId:gameId, language:language, target:thisWheel, results:gameResultsArray});
